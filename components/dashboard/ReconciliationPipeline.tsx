...
export default function ReconciliationPipeline({ status, data, aiMode, onStageClick }: Props) {
  ...
  const stages = [
    ...
    { id: "exceptions", title: "Exceptions", count: exceptions, desc: "Require attention", color: "bg-amber-600", ring: "ring-amber-300", text: "text-amber-700", clickable: true, filter: "EXCEPTIONS" },
